...
for category, series_list in series_by_category.items():
    for series in series_list:
        ...
        if series_category != category:
            print(f"[ERROR] Bad category classification for series {series['ticker']} in series_by_category: expected {category} but found {series_category}, series data: {series}")


print("Finished exploring markets by category and series!")